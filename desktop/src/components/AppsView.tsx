  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-400 mt-0.5">Manage apps on your connected Roku devices.</p>
      </div>
      ...
      <div className="bg-slate-800 border border-slate-700 rounded-xl p-10 flex flex-col items-center justify-center text-center text-slate-400 space-y-4">
        ...
        <div>
          <p className="font-medium text-white">No apps available</p>
          <p className="text-sm mt-1">Connect a Roku device to view and manage its apps.</p>
        </div>
        <button
          onClick={() => onStatusMessage('Scanning for devices…')}
